...
public class Grafo {
    ...
    public void adicionarVertice1(int indice, String rotulo) {
        if (matriz) {
            Vertice1 vertice = new Vertice1(indice);
            vertices.add(vertice);
        } else {
            Vertice1 vertice = new Vertice1(indice, rotulo);
    ...
    public int calcularGrau(int indiceVertice) {
        ...
        if (matriz) {
            ...
            return vertices.get(indiceVertice).getGrau1();
        }
    }
    ...
    public void imprimirGrafo() {
        ...
        if (matriz) {
            ...
            for (int i = 0; i < numVertices; i++) {
                for (int j = i + 1; j < numVertices; j++) {
                    if (matrizAdj[i][j] == 1) {
                        System.out.println(vertices.get(i).getRotulo1() + " - " + vertices.get(j).getRotulo1());
                    }
                }
            }
        } else {
        ...
        System.out.println("\nGrau dos vertices:");
        for (int i = 0; i < numVertices; i++) {
            System.out.println(vertices.get(i).getRotulo1() + ": " + calcularGrau(i));
        }
        int somador = 0;
